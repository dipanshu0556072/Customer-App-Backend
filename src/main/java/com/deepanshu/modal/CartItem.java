...
public class CartItem {
	...
	public CartItem(Long id, Cart cart, Product product, String size, int quantity, Integer price, Integer discountedPrice, String color, String category, Long userId) {
		this.id = id;
		this.cart = cart;
