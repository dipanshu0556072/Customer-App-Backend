...
public class WishlistController {
    ...
    @PutMapping("/add")
    public ResponseEntity<ApiResponse> addItemToWishlist(@RequestBody AddItemRequest req, @RequestHeader("Authorization") String jwt) throws UserException, ProductException{
