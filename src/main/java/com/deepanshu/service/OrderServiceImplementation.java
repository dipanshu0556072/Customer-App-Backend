...
import com.deepanshu.user.domain.PaymentStatus;
...
public class OrderServiceImplementation implements OrderService {
	...
	public OrderServiceImplementation(OrderRepository orderRepository,CartService cartService,WishlistService wishlistService,
	...
	public Order createOrder(User user, Address shippAddress) {
		...
		createdOrder.setTotalPrice(wishlist.getTotalPrice());
		createdOrder.setTotalDiscountedPrice(cart.getTotalDiscountedPrice());
		createdOrder.setTotalDiscountedPrice(wishlist.getTotalDiscountedPrice());
		createdOrder.setDiscounte(cart.getDiscounte());
		createdOrder.setDiscounte(wishlist.getDiscounte());
		createdOrder.setTotalItem(cart.getTotalItem());
		createdOrder.setTotalItem(wishlist.getTotalItem());
